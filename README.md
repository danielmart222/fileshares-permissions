...
- Add the Security Group Accountants to the Accounting folder and Assign the Accounting folder the Read/Write permission level
...
<h2> Step 8: Log into Client-1 as the Domain User fas.tacos </h2>
